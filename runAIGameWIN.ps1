...
$cwd = Get-Location
Start-Process -WorkingDirectory $cwd -FilePath "java" -ArgumentList "Server"
Start-Process -WorkingDirectory $cwd -FilePath "java" -ArgumentList "Client"
Start-Process -WorkingDirectory $cwd -FilePath "java" -ArgumentList "SimpleAI"
